...
const HomeView: React.FC<HomeViewProps> = ({ onSelect, rules, setRules }) => {
  ...
  // Embossed asterisk — debossed stamp effect using layered SVG shadows
  // Light edge on top-left, dark shadow on bottom-right = pushed-INTO surface illusion
  const EmbossedAsterisk = () => (
    <svg width="48" height="48" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" style={{ opacity: 0.55 }}>
      {/* Dark shadow layer — offset down-right, creates depth */}
      <path
        d="M12 3V21M4.2 7.5L19.8 16.5M19.8 7.5L4.2 16.5"
        stroke="rgba(0,0,0,0.55)"
        strokeWidth="2.2"
        strokeLinecap="round"
        transform="translate(0.6, 0.6)"
      />
      {/* Light highlight layer — offset up-left, creates raised edge illusion */}
      <path
        d="M12 3V21M4.2 7.5L19.8 16.5M19.8 7.5L4.2 16.5"
      ...
      />
      {/* Base layer — mid tone, the actual shape */}
      <path
        d="M12 3V21M4.2 7.5L19.8 16.5M19.8 7.5L4.2 16.5"
