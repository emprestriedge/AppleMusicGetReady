      ...
      <InkBackground>
        <div className="flex flex-col items-center justify-center h-full px-8 text-center">
          ...
          <div className="w-full max-w-sm space-y-6 stagger-entry stagger-2">
            <p className="text-zinc-400 font-garet text-sm leading-relaxed px-4">
            ...
            {isApple ? (
              ...
              >
                ...
                <span className="text-lg font-garet font-bold uppercase tracking-widest">Connect Apple Music</span>
              </button>
            ) : (
              <button 
                onClick={handleLogin}
              ...
              >
                ...
                <span className="text-lg font-garet font-bold uppercase tracking-widest">Connect Spotify</span>
              </button>
            )}
