...
/**
 * Heuristic to detect if running inside Google AI Studio preview or similar frames.
 * Supports explicit override via VITE_STUDIO_MODE env flag.
 */
const getStudioMode = (): boolean => {
  const envStudioMode = typeof process !== 'undefined' && process.env?.VITE_STUDIO_MODE;
  
  if (envStudioMode === "true") return true;
  if (envStudioMode === "false") return false;
...
export const IS_STUDIO_MODE = getStudioMode();
